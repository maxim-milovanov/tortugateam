...
local Bla_IMPs = {	
	{ name = GetItemName(ID), desc = GetItemDescription(ID), price_type = 0, price = 15, hot = 0, items = { {ID = 456, Qty = 1} }, param1 = 1, param2 = -1 },
	...
	{ name = GetItemName(ID), desc = GetItemDescription(ID), price_type = 0, price = 20, hot = 0, items = { {ID = 1020, Qty = 1} }, param1 = 1, param2 = -1 }
}	
	
local Bla_REP = {	
	{ name = GetItemName(ID), desc = GetItemDescription(ID), price_type = 1, price = 1500, hot = 0, items = { {ID = 455, Qty = 1} }, param1 = 1, param2 = -1 },
	{ name = 'Socket set', desc = 'Socket set', price_type = 1, price = 7500, hot = 0, items = { {ID = 890, Qty = 1}, {ID = 891, Qty = 1} }, param1 = 1, param2 = -1 },
	{ name = GetItemName(ID), desc = GetItemDescription(ID), price_type = 1, price = 2000, hot = 0, items = { {ID = 1020, Qty = 1} }, param1 = 1, param2 = -1 }
}				
