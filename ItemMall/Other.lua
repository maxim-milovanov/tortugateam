...
local Oth_IMPs = {
	...
	{ name = 'Voodoo Doll x10', desc = 'Remove one time death experience penalty', price_type = 0, price = 30, hot = 0, items = { {ID = 3846, Qty = 10} }, param1 = 1, param2 = -1 }
}
...
local Fishing_IMPs = {
	...
	{ name = 'Fish bait x99', desc = 'Feeding reduces the time of catching fish. Keep it in your backpack. Reduces fishing time by 60 seconds.', price_type = 0, price = 99, hot = 0, items = { {ID = 12478, Qty = 99} }, param1 = 1, param2 = -1 }
}
