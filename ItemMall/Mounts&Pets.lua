...
local Mounts = {
	...
	{ name = GetItemName(19499), desc = GetItemDescription(19499), price_type = 0, price = 1200, hot = 0, items = { {ID = 19499, Qty = 1} }, param1 = 1, param2 = -1 },
	{ name = GetItemName(19509), desc = GetItemDescription(19509), price_type = 0, price = 3000, hot = 0, items = { {ID = 19509, Qty = 1} }, param1 = 1, param2 = -1 },
	{ name = GetItemName(19510), desc = GetItemDescription(19510), price_type = 0, price = 3000, hot = 0, items = { {ID = 19510, Qty = 1} }, param1 = 1, param2 = -1 },
	{ name = GetItemName(19511), desc = GetItemDescription(19511), price_type = 0, price = 3000, hot = 0, items = { {ID = 19511, Qty = 1} }, param1 = 1, param2 = -1 },
	{ name = GetItemName(19512), desc = GetItemDescription(19512), price_type = 0, price = 3000, hot = 0, items = { {ID = 19512, Qty = 1} }, param1 = 1, param2 = -1 },
	{ name = GetItemName(19513), desc = GetItemDescription(19513), price_type = 0, price = 3000, hot = 0, items = { {ID = 19513, Qty = 1} }, param1 = 1, param2 = -1 },
	{ name = GetItemName(19514), desc = GetItemDescription(19514), price_type = 0, price = 3000, hot = 0, items = { {ID = 19514, Qty = 1} }, param1 = 1, param2 = -1 },
	{ name = GetItemName(19515), desc = GetItemDescription(19515), price_type = 0, price = 3000, hot = 0, items = { {ID = 19515, Qty = 1} }, param1 = 1, param2 = -1 },
	{ name = GetItemName(19516), desc = GetItemDescription(19516), price_type = 0, price = 3000, hot = 0, items = { {ID = 19516, Qty = 1} }, param1 = 1, param2 = -1 },
